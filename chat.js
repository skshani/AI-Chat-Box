...
//let text2 =document.querySelector(".ai-chat-area")
...
async function generateResponse(aiChatBox) {
    ...
    //let text2 = aiChatBox.querySelectorAll('.ai-chat-area')
    let requestOption={
        method:"POST",
...
function chatResponsehandle(message){
    user.data=message
let html=`<img src="" alt="" id="userImage" width="50">
            ...
            setTimeout(()=>{
                let html1 =`<img src="" alt="" id="aiImage" width="50">
                           <div class="ai-chat-area">
                          </div>`
                          let aiChatBox =(html1,"ai-chat-box")
